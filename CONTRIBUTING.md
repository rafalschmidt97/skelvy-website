...
1. In GitHub, send a pull request to `skelvy-website:master`.
...
To ensure consistency throughout the source code, keep standard php rules.
...
bugfix(blog) add missing translations
```
...
[github]: https://github.com/rafalschmidt97/skelvy-website
[pulls]: https://github.com/rafalschmidt97/skelvy-website/pulls
